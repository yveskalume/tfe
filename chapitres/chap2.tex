...
\begin{enumerate}
	...
	\item L’utilisateur doit s’authentifier en soumettant son identité avant d’accéder à l’application
	\item L’administrateur doit s’authentifier avec un mot de passe avant d’accéder à l’espace d’administration
...
\begin{enumerate}[label=\alph*.]
	...
	\begin{itemize}
		...
		\begin{enumerate}[label=\arabic*.]
			...
			\item Tant que le tracking est active, le service de messagerie envoie des alertes
		\end{enumerate}
		\item Scenario alternatif :
		\begin{enumerate}[label=\arabic*.]
